"""Semantic splitting helpers mirroring the legacy agent."""
    ...
    try:
        ...
        try:
            ...
            class BaseEmbedding(object):  # type: ignore
                """Fallback to keep this module importable without LlamaIndex."""
...
def semantic_split(
    ...
    *,
    ...
    """Replicates the legacy semantic chunking strategy using cosine similarity."""
